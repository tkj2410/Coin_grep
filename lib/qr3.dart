...
class _QRViewExampleState extends State<QRViewExample> {
  ...
  Future<String> getOutput(String? _input) async
  {
    ...
    var url ="http://10.0.2.2:8000/read_qr?qr=$_input";
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (result != null)Padding(
                    padding: const EdgeInsets.only(left: 10.0, right: 19.0 ),
                    child: (
                            ...
                            child: FutureBuilder(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.data != null) {
                                  return const Text(
                                      'Flip Camera');//'flip ${describeEnum(snapshot.data!)}');
                                } else {
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            String output = await getOutput(result!.code);
                            if(output == "---"){
